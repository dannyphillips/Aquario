...
import Newtank from '../components/Newtank/index';
...
class NewtankPage extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <Heading2>Create a new Tank</Heading2>
        <TitleContainer>
          <TitleLabel htmlFor="newTankTitle">Title</TitleLabel>
          <TitleInput
            id="newTankTitle"
            value={title}
